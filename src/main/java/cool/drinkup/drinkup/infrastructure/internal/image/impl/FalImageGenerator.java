...
public class FalImageGenerator implements ImageGenerator {
    ...
    public FalImageGenerator(FalProperties falProperties) {
        ...
        this.falClient = FalClient.withConfig(
                ClientConfig.withCredentials(CredentialsResolver.fromApiKey(falProperties.getApiKey())));
    }
    ...
    public String generateImage(String prompt) {
        ...
        var result = falClient
                .queue()
                .status(this.falProperties.getEndpointId(), QueueStatusOptions.withRequestId(requestId));
        ...
        var output = falClient
                .queue()
                .result(this.falProperties.getEndpointId(), QueueResultOptions.withRequestId(requestId));
