...
public class BarStockController {
    ...
    public ResponseEntity<CommonResp<List<BarStockVo>>> getBarStock(
        ...
        return ResponseEntity.ok(CommonResp.success(
                barStock.stream().map(batStockMapper::toBarStockVo).collect(Collectors.toList())));
    }
    ...
    public ResponseEntity<CommonResp<List<BarStockVo>>> createBarStock(
        ...
        return ResponseEntity.ok(CommonResp.success(
                createdBarStocks.stream().map(batStockMapper::toBarStockVo).collect(Collectors.toList())));
    }
    ...
    public ResponseEntity<CommonResp<BarStockVo>> updateBarStock(
        ...
        return ResponseEntity.ok(CommonResp.success(batStockMapper.toBarStockVo(updatedBarStock)));
    }
