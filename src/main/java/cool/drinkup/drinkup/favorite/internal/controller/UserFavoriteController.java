...
public class UserFavoriteController {
    ...
    public ResponseEntity<CommonResp<Void>> addFavorite(
    ...
    public ResponseEntity<CommonResp<Page<UserFavoriteDTO>>> getUserFavorites(
            ...
            @Parameter(description = "分页参数") @PageableDefault(size = 20, sort = "favoriteTime", direction = Sort.Direction.DESC) Pageable pageable) {
